    ...
    <form id="form1" runat="server">
        <div class="container">
            <h2 class="text-center">
                <asp:Label ID="Label1" runat="server" Text="Label" Font-Bold="true" ForeColor="#990033">HỒ SƠ ĐĂNG KÝ</asp:Label>

            </h2>
            <div class="row border border-primary bg-nen1 ">
                <div class="col-md-8 p-2 text-center badge-secondary font-weight-bold">
                     Thông tin đăng nhập
                </div>
                <div class="col-md-4 pt-2 text-center border-left border-primary badge-secondary font-weight-bold">
                    Hồ sơ khách hàng
                </div>
            </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="row mb-2">
                     ...
                     <div class="row mb-2 bg-nen1">
                        <div class="col-md-12 text-center p-2 badge-secondary font-weight-bold">
                            Thông tin cá nhân
                        </div>                       
                    </div>
                     <div class="row mb-2">
